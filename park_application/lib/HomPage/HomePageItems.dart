  ...
  getTotalPrice() {
    return Container(
      ...
      child: RichText(
        text: TextSpan(
          text: 'Hesap Bakiyesi:',
          style: GoogleFonts.montserrat(color: Color(0xFFB0B3BA), fontSize: 13),
          children: <TextSpan>[
            TextSpan(
              text: '   +95.75 ₺',
    ...
    return Column(
      children: [
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            getInfo('HESAP BAKİYESİ','+95.75 ₺',Color(0xff3E64FF)),
            getInfo("AYLIK SÜRE","11.45 Saat",Color(0xFFFE4A5E)),
          ],
        ),
        SizedBox(
          height: 15,
        ...
        Row(
          mainAxisAlignment: MainAxisAlignment.spaceBetween,
          children: [
            getInfo("FAVORİM","Kayseri Forum",Color(0xffFF9401)),
            getInfo("FAVORİM","Kayseri Forum",Color(0xFF20D22C)),
          ],
        ),
      ],
    );
  ...
  carIdentity() {
    return Container(
      ...
      child: Row(
        ...
        crossAxisAlignment: CrossAxisAlignment.center,
        children: [
          Image.asset("images/clio.png",height: 50,),
          SizedBox(),
          Container(
            width: 200,
            alignment: Alignment.center,
